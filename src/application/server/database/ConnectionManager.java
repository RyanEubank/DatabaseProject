...
public class ConnectionManager {
	...
	private Properties m_properties; // user and pass for the database connection
	...
	/**
	 * Calls the JDBC driver manager to open a new connection to the library 
	 * database with the set username and password in the connection properties. 
	 * Call {@link #setUsername(String)} and {@link #setPassword(String)} 
	...
	private ConnectionManager() {
		// not strictly required as of JDBC 4, but included just in case
		registerJDBCDriver();
